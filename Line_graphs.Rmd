...
```
#Gerate random data points for y-axis labels
```{r}
generate_random_data <- function(trend, n = 7, min_val = 0, max_val = 100, type = "E", constant_range = NULL) {
  
  # Generate random data based on the trend in material file (0 for decrease, 1 for increase, 2 for fluctuate)
...
```
#to be removed later: write on expermint psy folder
```{r}
